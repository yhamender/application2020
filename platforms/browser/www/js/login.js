angular.module('starter.login', [])
  .controller('loginCtrl', function ($scope, $rootScope, $state, $stateParams, $cordovaInAppBrowser,
    ...
    $scope.browser = function () {
      ...
      $cordovaInAppBrowser.open("http://greenschoolsprogramme.org/audit/register/", '_blank', options)
        .then(function (event) {
          // success
    ...
    $scope.submitForm = function (user) {
      ...
      // $state.go('app.home');
      // end test code
     $http.get("http://greenschoolsprogramme.org/audit/api/Gsp/users/email/" + email + "/password/" + password)
