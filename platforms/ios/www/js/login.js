angular.module('starter.login', [])
  .controller('loginCtrl', function ($scope, $rootScope, $state, $stateParams, $cordovaInAppBrowser,
    ...
    $scope.browser = function () {
      ...
      $cordovaInAppBrowser.open("http://greenschoolsprogramme.org/audit/18/register/", '_blank', options)
        .then(function (event) {
          // success
    ...
    $scope.submitForm = function (user) {
      ...
      // $state.go('app.home');
      // end test code
     $http.get("http://greenschoolsprogramme.org/audit/18/api/Gsp/users/email/" + email + "/password/" + password)
